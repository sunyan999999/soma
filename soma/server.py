"""SOMA Standalone HTTP Server — v2.0.6-dev
...
app = FastAPI(title="SOMA API Server", version="2.0.6-dev")
...
@app.get("/health")
def health():
    return {"status": "ok", "version": "2.0.6-dev"}
...
def main():
    ...
    print(f"SOMA Server v2.0.6-dev starting on http://localhost:{port}")
