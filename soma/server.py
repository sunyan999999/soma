"""SOMA Standalone HTTP Server — v2.0.18.3
...
app = FastAPI(title="SOMA API Server", version="2.0.18.3")
...
@app.get("/health")
def health():
    return {"status": "ok", "version": "2.0.18.3"}
...
def main():
    ...
    print(f"SOMA Server v2.0.18.3 starting on http://localhost:{port}")
