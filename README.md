# SOMA v2.0.2 — The Cognitive Kernel for AI Agents
...
<p align="center">
  ...
  <a href="CHANGELOG.md"><img src="https://img.shields.io/badge/changelog-v2.0.2-success" alt="Changelog"></a>
  <a href="#"><img src="https://img.shields.io/badge/milestone-2.0.2-ff6b6b" alt="Milestone"></a>
</p>
...
## v2.0.2 — Zhongdao Closed Loop

**v2.0.2 closes the Zhongdao feedback loop** — from correction to verification to optimization:
...
**Benchmark validated** on 零熵智库 (v2.0.2): Overall 80.5 (+5.8 vs v1.1.2), Memory 79.7 (+20.2), Wisdom 76.2, Evolution 75.0, Scalability 100.0. 650 tests passed.

Every capability line that started as a seed in v0.1 has grown into a complete system:

| Capability Line | Core Question | v2.0.2 Answer |
|---|---|---|
