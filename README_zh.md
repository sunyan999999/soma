...
<p align="center">
  ...
  <a href="CHANGELOG.md"><img src="https://img.shields.io/badge/变更日志-v1.1.4-success" alt="变更日志"></a>
  <a href="#"><img src="https://img.shields.io/badge/里程碑-1.1.4-ff6b6b" alt="里程碑"></a>
</p>
...
**v1.1.4 闭合中道引擎反馈环路** — 从"执行校正"到"验证效果"到"智能优化"：
...
**基准验证** 于零熵智库 v1.1.4：综合 80.5 (+5.8)，记忆 79.7 (+20.2)，智慧 76.2，进化 75.0，伸缩 100.0。650 测试通过。

从 v0.1 埋下的每一颗种子，到 v1.1.4 长成的完整系统：
...
v1.1.4 延续了自动记忆分层——系统在你使用的过程中，默默构建对你的理解：
...
soma = SOMA(
    ...
    top_k=5,                      # 默认召回数
    agent_id="",                  # v1.1.4: 多Agent身份标识
    group_id="",                  # v1.1.4: 团队/组织级共享
)
...
SOMA v1.1.4 — 使用 1,050 条零熵智库生产记忆，5轮统计基准测试：
