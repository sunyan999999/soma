...
<p align="center">
  ...
  <a href="#"><img src="https://img.shields.io/badge/测试-511%2F511-brightgreen" alt="测试"></a>
  <a href="CHANGELOG.md"><img src="https://img.shields.io/badge/变更日志-v1.0.0-success" alt="变更日志"></a>
  <a href="#"><img src="https://img.shields.io/badge/里程碑-1.0-ff6b6b" alt="里程碑"></a>
</p>
...
**v1.0 不只是版本号的跳跃。** 这是五条能力线——记忆、推理、协作、进化、工程——从各自萌芽到完整交汇的时刻。SOMA 从"实验性工具"进化为"可生产的认知内核"。

从 v0.1 埋下的每一颗种子，到 v1.0 长成的完整系统：
...
| **进化** | AI能从自己的经验中学习吗？ | 反思 → 调权 → 固化 → 分享 |
| **工程** | 如何证明这些能力是真实的？ | 511测试 + 五维基准 + 竞品对比 |
...
v1.0 引入了自动记忆分层——系统在你使用的过程中，默默构建对你的理解：
...
soma = SOMA(
    ...
    top_k=5,                      # 默认召回数
    agent_id="",                  # v1.0: 多Agent身份标识
    group_id="",                  # v1.0: 团队/组织级共享
)
...
SOMA v1.0 — 使用 1,050 条零熵智库生产记忆，5轮统计基准测试：
...
pytest -v --cov=soma --cov-report=term    # 511 测试，~97% 覆盖率
