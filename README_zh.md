...
<p align="center">
  ...
  <a href="#"><img src="https://img.shields.io/badge/测试-618%2F618-brightgreen" alt="测试"></a>
  <a href="CHANGELOG.md"><img src="https://img.shields.io/badge/变更日志-v1.1.1-success" alt="变更日志"></a>
...
**v1.1.1 是生产环境精炼版。** 经零熵智库实际测试反馈，五条能力线——记忆、推理、协作、进化、工程——现配备 L1/L2 复杂度自适应和完全并行化多Agent调度。

从 v0.1 埋下的每一颗种子，到 v1.1.1 长成的完整系统：
...
| **工程** | 如何证明这些能力是真实的？ | 618测试 + 五维基准 + 竞品对比 |
...
v1.1.1 延续了自动记忆分层——系统在你使用的过程中，默默构建对你的理解：
...
soma = SOMA(
    ...
    top_k=5,                      # 默认召回数
    agent_id="",                  # v1.1.1: 多Agent身份标识
    group_id="",                  # v1.1.1: 团队/组织级共享
)
...
SOMA v1.1.1 — 使用 1,050 条零熵智库生产记忆，5轮统计基准测试：
...
pytest -v --cov=soma --cov-report=term    # 618 测试，~97% 覆盖率
